...
def updateSettingsConfig(settings, config):
    ...
    settings['WORKFLOW']['TRAIN']['configurations']['max_epochs'] = [config['max_epochs']]
    ...
    settings['WORKFLOW']['TRAIN']['configurations']['focal_loss_gamma'] = [config['focal_loss_gamma']]
    settings['WORKFLOW']['TRAIN']['configurations']['focal_loss_alpha'] = [config['focal_loss_alpha']]
