...
def defined_inconsistent_configurations_create(settings_dict):
    ...
    result = subprocess.run(["java", f"-Dlog.dir={log_dir}", "-jar",  # "-Xmx4G",
                            #  r"C:\Users\User\Documents\Studium\Promotion\MF4ChocoSolver-main\LinuxConfiguration\fm_conf_gen_v2.jar",
                            #  r"C:\Users\User\Documents\Studium\Promotion\MF4ChocoSolver-main\LinuxConfiguration\REAL-FM-4.sxfm",
                            
                                jar_path, fm_path,
                             settings_dict["COMBINATION_FILE_PATH"], "2", "194", "10"], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
...
settings_dict = {
    "CANDIDATE_FILE_PATH": os.path.join("candidate"),
    "COMBINATION_FILE_PATH": os.path.join("Combinations", "real-fm", "comb 16"),
    "CONFIGURATION_FILE_PATH": os.path.join("conf"),
    "INCONSISTENT_FILE_PATH": os.path.join("Inconsistent", "real-fm", "comb16"),
    "DIAGNOSIS_FILE_PATH": os.path.join("data"),
    "OUTPUT_FILE_PATH": os.path.join("Learning Data Input", "real-fm_dataset", "TrainingData_comb16.csv"),
